    ...
    return(
        <section className="bg-white dark:bg-black">
            <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16">
                ...
                <div className="mt-14 grid grid-cols-1 lg:grid lg:grid-cols-3 md:grid md:grid-cols-2 text-left">
                    <div className="max-w-sm p-6 bg-white border-gray-200 rounded-2xl shadow dark:bg-gray-800 dark:border-gray-700 border-2">
