            ...
            <footer className="bg-white">
                <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                    ...
                    <div className="sm:flex sm:items-center sm:justify-between">
                        <span className="text-sm text-gray-500 sm:text-center">© 2024 <a href="https://viewpoint.vercel.app/" className="hover:underline">View Point™</a>. All Rights Reserved.
                        </span>
                        <div className="flex mt-4 sm:justify-center sm:mt-0">
                            <a href="https://soraofficial.vercel.app" className="text-gray-500 hover:text-gray-900 ms-5">
                            ...
                            <a href="https://github.com/soracompagnie" className="text-gray-500 hover:text-gray-900 ms-5">
                            ...
                            <a href="https://instagram.com/soraweb._" className="text-gray-500 hover:text-gray-900 ms-5">
                                <svg className="w-4 h-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                                    <path fill="currentColor" fill-rule="evenodd" d="M3 8a5 5 0 0 1 5-5h8a5 5 0 0 1 5 5v8a5 5 0 0 1-5 5H8a5 5 0 0 1-5-5V8Zm5-3a3 3 0 0 0-3 3v8a3 3 0 0 0 3 3h8a3 3 0 0 0 3-3V8a3 3 0 0 0-3-3H8Zm7.597 2.214a1 1 0 0 1 1-1h.01a1 1 0 1 1 0 2h-.01a1 1 0 0 1-1-1ZM12 9a3 3 0 1 0 0 6 3 3 0 0 0 0-6Zm-5 3a5 5 0 1 1 10 0 5 5 0 0 1-10 0Z" clip-rule="evenodd"/>
                                </svg>                          
                                <span className="sr-only">Instagram account</span>
                            </a>
                            <a href="https://linkedin.com/company/soraweb" className="text-gray-500 hover:text-gray-900 ms-5">
